...
const mockListings = [
  ...
  },
  {
    ...
    location: "Lagos, Nigeria",
    status: "rejected",
    provider: "Quick Movers Ltd",
    providerAvatar: null,
    rating: 4.2,
    reviews: 8,
    submitted: "1 day ago",
    image: "/b-11.jpg",
    rejectionReason: "Incomplete service description and missing credentials",
  },
  {
    id: 5,
      ...
      <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500">
            Manage and moderate service provider listings on the platform.
          </p>
        </div>
      </div>
        ...
        <div className="flex-1 overflow-y-auto px-4 sm:px-6 py-4 space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-4 text-sm">
            ...
            <div>
              ...
              <p className="font-medium capitalize">{selectedListing.category}</p>
            </div>
            <div>
              <p className="text-gray-400">provider</p>
              <p className="font-medium">{selectedListing.provider}</p>
            </div>
            <div>
